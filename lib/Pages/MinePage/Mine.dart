...
class _MineState extends ConsumerState<Mine> {
  ...
  Widget build(BuildContext context) {
    ...
    return ref.watch(Glob.GlobalData.loginStatue.state).state==true?
...
Widget Mine1(String _img,List _list,List _listItem,var _size,Color _color){
  return Consumer(builder: (  BuildContext context, WidgetRef ref, Widget? child,){
    var UserInfo = ref.watch(Glob.GlobalData.LoginResult.state).state;
    return Flex(
        ...
        Expanded(flex: 2,child: Container(child: Row(
          children: [
            Expanded(flex: 4,child: Container(child:CircleAvatar(
              radius: 40.r,
             backgroundImage: NetworkImage(UserInfo==null?_img:UserInfo.profilePicture),),)),
            Expanded(flex: 6,child: Container(child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    Text(UserInfo==null?"小星星":UserInfo.username,style: TextStyle(fontSize: 17),),
                    SizedBox(width: 5,),
                    SwitchPage(1)
                  ],),
                Text(UserInfo==null?"UID:uy734757":"UID:${UserInfo.UserId}",style: TextStyle(color: Color.fromRGBO(140, 165, 206, 1)),),
                SizedBox(height: 5,),
                Text(UserInfo==null?"推荐人:18381893230":"推荐人:${UserInfo.invitePerson}",style: TextStyle(color: Color.fromRGBO(140, 165, 206, 1)),),
              ],
            ),)),
          ],
        ),)),
    ...
    return Flex(
      ...
      children: [
        Expanded(flex: 1,child:Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
            Text(UserInfo==null?"小星星":UserInfo.username,style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20),),
            SwitchPage(0)
          ],
        )),
            ...
            Expanded(flex: 8,child: Container(
              decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                      image: NetworkImage(UserInfo==null?_img:UserInfo.profilePicture),
                      fit: BoxFit.contain
                  )
              ),
            )),
        ...
        Expanded(flex: 1,child: Text(UserInfo==null?"Falling in love with yourself first doesn't make youvain or selfish, it makes you indestructible.":UserInfo.userContent)),
