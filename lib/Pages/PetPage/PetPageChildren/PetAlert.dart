...
class _PetBuyState extends ConsumerState<PetBuy> {
  ...
  GetToken()async{
    var UserId=ref.read(GlobalData.LoginResult.state).state.UserId;
    var token =  await Request.setNetwork("/UserConfig/QiNiu", {"userId":UserId});
    print("获取token:$token");
    return token;
  }
  @override
                ...
                children: [
                  InkWell(
                    onTap: ()async{
                         ...
                         var result= await Creamer.GetGrally(token["Result"]);
                  ...
                  Container(
                    ...
                    child: MaterialButton(onPressed: ()async{
                      if ((FormKey.currentState as FormState).validate()) {
                        //验证通过提交数据
                      var result = await Request.setNetwork("UserCenter/pet", {
